...
import { createProject, deleteProject, getAllProjects, getProject, projectProgress, updateProject , projectDashboard } from "../controllers/project.controller.js"
...
router.get(
"/:projectId/dashboard",authMiddleware,projectDashboard);
